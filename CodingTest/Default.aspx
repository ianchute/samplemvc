...
<body>
    ...
    <div> 
		...
		1. Create a simple table that outputs Email Label, From Address, and Date Updated from the items within the 
			Modules.Business.EmailTemplates class.  
		
		2. Allow the table to be displayed in a paged fashion, showing 10 items per page.
		
		3. Allow the column headers to order the page items differently when clicked.
